 ...
 * 
 * 3. Escreva uma classe para representar um Aluno. Adicione atributos relacionados as caracteristicas de um Aluno, como nome, matricula, 
 * curso que esta matriculado, nome de 3 disciplinas que esta cursando e as notas dessas 3 disciplinas. Desenvolva um metodo para verificar 
 * se o aluno esta aprovado (nota maior ou igual a 7) em uma determinada disciplina. Escreva um programa para testar essa classe, 
 * que pede as informacoes do aluno ao usuario e ao final informa o nome das disciplinas, mostra as notas e mostra se o aluno foi 
 * aprovado ou nao.
 */
