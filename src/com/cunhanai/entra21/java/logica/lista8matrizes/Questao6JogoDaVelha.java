 ...
 * 
 * Questao_6: Faça um programa para jogar o jogo da velha. O programa deve permitir que dois jogadores façam uma partida do 
 * jogo da velha, usando o computador para ver o tabuleiro. Cada jogador vai alternadamente informandoa posição 
 * onde deseja colocar a sua peça (‘O’ ou ‘X’). O programa deve impedir jogadas invalidas e determinar automaticamente 
