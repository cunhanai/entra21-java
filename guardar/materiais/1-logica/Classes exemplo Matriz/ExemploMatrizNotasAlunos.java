...
public class ExemploMatrizNotasAlunos {
	...
	public static void main(String[] args) {
		...
		double[] []  notasAlunos  =  new double[3][4]; // Declara��o da Matriz array bidimensional 
														//com express�es de cria��o de array.
		
		
		//Atribui��o dos valores na Matriz
		//LINHA 0
		notasAlunos[0] [0] = 10;
		notasAlunos[0] [1] = 7;
		notasAlunos[0] [2] = 8;
		...
		/*for(int i = 0; i < notasAlunos.length; i++) { OUTRA FORMA DE PERCORRER A MATRIZ
		...
		System.out.println("Tamanho array: " + notasAlunos.length);
		
		/*for(int i = 0; i < notasAlunos.length; i++) {
		System.out.printf(" " + notasAlunos[i] + " "); OUTPUT DO ENDEREÇO DE MEMÓRIA		
		}*/
